module.exports = function (app) {
  ...
  app.get('/wcv4/home', function (req, res) {
    req.session.destroy()
    res.render('wcv4/home')
  })

  app.post('/wcv4/search-entry', function (req, res) {
  ...
  app.post('/wcv4/status-changing', function (req, res) {
    // Get the answer from session data
    // The name between the quotes is the same as the 'name' attribute on the input elements
    // However in JavaScript we can't use hyphens in variable names
  ...
  app.post('/wcv4/upload-logic', function (req, res) {
    // Get the answer from session data
    // The name between the quotes is the same as the 'name' attribute on the input elements
    // However in JavaScript we can't use hyphens in variable names
  ...
  app.post('/wcv4/not-verified-reason-logic', function (req, res) {
  ...
  app.post('/wcv4/not-verified-another-appointment-logic', function (req, res) {
  ...
  app.post('/wcv4/not-verified-has-another-logic', function (req, res) {
  ...
  app.post('/wcv4/add-clerical-upload-evidence-logic', function (req, res) {
    // Get the answer from session data
    // The name between the quotes is the same as the 'name' attribute on the input elements
    // However in JavaScript we can't use hyphens in variable names
  ...
  app.post('/wcv4/withdrawn-confirmation-logic', function (req, res) {
